          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                leading: Icon(Icons.celebration,color: cobir?Colors.black:Colors.black54,),
                ...
                ExpansionTile(
                  ...
                  leading: Icon(Icons.account_balance,color: coabout?Colors.black:Colors.black54,),
                  title: Text("Write About Yourself",style: TextStyle(color: Colors.black,fontWeight: coabout?FontWeight.bold:FontWeight.normal),),
                  childrenPadding: EdgeInsets.symmetric(horizontal: 10),
                  children: [
                    TextFormField(
                      controller: txtaboutyou,
                      decoration: InputDecoration(
